...
namespace gt
{
	GTCAnt::GTCAnt(GTGame& mGame, GTCDnaController& mCDnaController, GTCPhysics& mCPhysics, GTCRender& mCRender) : game(mGame),
		cDnaController(mCDnaController), cPhysics(mCPhysics), cRender(mCRender), body(cPhysics.getBody())
	{
